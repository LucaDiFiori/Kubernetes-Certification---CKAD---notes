...
1. **Semplicità di aggiornamento**: Puoi aggiornare i Secrets senza dover modificare il codice del pod o riavviarlo. I pod possono essere configurati per rilevare automaticamente i cambiamenti.
...
***
## Iniezione del Secre nel pod
Vediamo come iniettare i Secrets come variabili d'ambiente nei Pod:

Per aggiungere una nuova variabile d'anbiente aggiungo la proprietà (lista): **envFrom**
...
Questo renderà i dati del secret specificato disponi come varibili d'anbiente nel mio pod
...
Ci sono altri modo per iniettare i Secret
